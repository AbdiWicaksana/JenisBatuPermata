...
public class ListAdapter extends RecyclerView.Adapter<ListAdapter.ViewHolder> {
    ...
    public ListAdapter(Context context, ArrayList<String> imagejbNames, ArrayList<String> jbImages, ArrayList<String> jbImagesDesc , ArrayList<String> jbDescriptionDetail ) {
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public ViewHolder(@NonNull View itemView) {
            ...
            jbImagesDesc = itemView.findViewById(R.id.deskripsi);
